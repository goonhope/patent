# -*- coding: utf-8 -*-
import os, re, shutil, cchardet, time, img2pdf, zipfile,xlwt
...
def copy_req_dirs(source,location):
    """复制符合要求的文件夹，后期可能需要修改"""
...
@timer
def filed(location, source=True):
    ...
    if source:
        ...
        if os.path.exists(source):
            copy_req_dirs(source, location)  # 复制
        else:
